...
import { faArchive, faHome, faInfoCircle, faTag } from '@fortawesome/free-solid-svg-icons'
...
const MenuButtonGroup = ({ allowCollapse = false }) => {
  ...
  const links = [
    ...
    { id: 3, icon: faTag, name: locale.NAV.TAG, to: '/tag', show: BLOG.showArchive },
    { id: 3, icon: faArchive, name: locale.NAV.ARCHIVE, to: '/archive', show: BLOG.showArchive }
    // { id: 4, icon: faRss, name: locale.NAV.RSS, to: '/feed', show: true }
