...
export default function BlogAround({ prev, next }) {
  ...
  return (
    <section className="hidden text-gray-800 border-t dark:border-gray-600 dark:text-gray-300 md:flex flex-wrap lg:flex-nowrap lg:space-x-10 justify-between py-2 mx-32">
      ...
      <Link href={`/article/${next.slug}`} passHref>
        <a className="text-sm flex py-3 text-gray-400 hover:underline cursor-pointer">
          {next.title}
